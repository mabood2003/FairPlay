  ...
  return (
    <div className="w-full max-w-md">
      ...
      <Link href="/" className="flex items-center justify-center gap-2 mb-8">
        ...
        <span className="text-3xl font-bold text-gray-900">FairPlay</span>
      </Link>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition mb-6 disabled:opacity-50"
        >
